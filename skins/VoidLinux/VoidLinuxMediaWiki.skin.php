<?php
/**
 * VoidLinux - A basic MediaWiki skin based on Twitter's excellent Bootstrap CSS framework
 *
 * @Version 1.0.0
 ...
 * @subpackage Skins
 */
class SkinVoidLinuxMediaWiki extends SkinTemplate {
	/** Using Bootstrap */
	public $skinname = 'voidlinux-mediawiki';
	public $stylename = 'voidlinux-mediawiki';
	public $template = 'VoidLinuxMediaWikiTemplate';
	...
	public function initPage( OutputPage $out ) {
		global $wgSiteJS;
		parent::initPage( $out );
		$out->addModuleScripts( 'skins.voidlinuxmediawiki' );
 ...
 * @subpackage Skins
 */
class VoidLinuxMediaWikiTemplate extends QuickTemplate {
	/**
	...
	/**
	 * Template filter callback for VoidLinux skin.
